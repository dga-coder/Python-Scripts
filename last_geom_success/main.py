...
f = open(u"D:\\map_from_maira_181114\\OT\\polygon_OT_merg.csv","w")
polygList = []
polygshapefile = u"D:\\map_from_maira_181114\\OT\\Merged_polygon_OT.shp"
count=0
for dirpath, dirnames, filenames in arcpy.da.Walk(in_workspace, datatype="FeatureClass", type="Polygon"):
    for filename in filenames:
        if (filename.endswith(".shp") and '_OT_' in filename):
            count +=1
